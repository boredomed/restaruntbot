...
demo.prototype = (function() {
        ...
        $(function() {
          ...
          chatbotResponse = function(text) {
           ...
           myCallback = function(data) {
              ...
              //console.log(rtext);
              sendMessage(rtext,botSide,botStatus);
              //do Something}
            };
          ...
          sendResponse = function(text) {
            ...
            //sendQuery(myCallback,text);
            previousUserMessage = text;
           // chatbotResponse(text);
            return setTimeout(function() {
              return sendQuery(myCallback, text);
           // sendQuery(myCallback, text);
          },1000);
  ...
  function createSession() {
    ...
    function sendQuery(callback,quest) {

      console.log('In Send Query');

      console.log("In callback 2")
      var message_input = $(".input_message").val();

      var query = {"query": quest};
